...
export const MOCK_DASHBOARD: DashboardData = {
  ...
  funnelStages: [
    { stageKey: 'h1', label: 'Applicants', count: 3675, colorZone: 'primary' },
    { stageKey: 'h2', label: 'Screened', count: 3273, conversionPct: 89.06, colorZone: 'primary' },
    { stageKey: 'h3', label: 'Assessment', count: 657, conversionPct: 20.07, colorZone: 'primary' },
    { stageKey: 'h4', label: 'Interviews', count: 439, conversionPct: 66.82, colorZone: 'amber' },
    { stageKey: 'h5', label: 'Offer', count: 71, conversionPct: 16.17, colorZone: 'amber' },
    { stageKey: 'h6', label: 'Hired', count: 69, conversionPct: 97.18, colorZone: 'amber' },
  ],
  stageDurations: [
    { fromStage: 'h0', toStage: 'h1', days: 9, colorToken: 'primary' },
    { fromStage: 'h1', toStage: 'h2', days: 8, colorToken: 'primary' },
    { fromStage: 'h2', toStage: 'h3', days: 16, colorToken: 'teal' },
    { fromStage: 'h3', toStage: 'h4', days: 11, colorToken: 'blue' },
    { fromStage: 'h4', toStage: 'h5', days: 55, colorToken: 'amber' },
    { fromStage: 'h5', toStage: 'h6', days: 2, colorToken: 'amber' },
  ],
};
